<template>
  <div>
    ...
    <section class="section-home-six">
      <div class="head-title">
        <h3>Engage Visitors</h3>
        <h1>Understand your <br>audience</h1>
      ...
      <div class="columns card-content">
        <div class="column">
          <div class="card">
            <img src="~assets/image/developer.png">
            <h3>Developers</h3>
          </div>
        </div>
        <div class="column">
    ...
    <section class="section-home-seven">
      <div class="container">
        ...
        <div class="head">
          <h3>Trusted by the world’s most innovative businesses – big and small</h3>
    ...
    <section class="section-home-eight">
      <div class="hiring">
        <div class="head">
          ...
          <a class="btn primary">More about Company</a>
        </div>
        <div class="career-position">
          <div class="list">
            <div class="position">
              <h3>Front-End Developer</h3>
              <small>Los Angeles / Remote</small>
            </div>
          </div>
          <div class="list">
            <div class="position">
              <h3>Community Manager</h3>
              <small>New York / Full-Time</small>
            </div>
          </div>
          <div class="list">
            <div class="position">
